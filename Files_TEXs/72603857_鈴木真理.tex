...
\point{1. 分析結果の共通点}{
    \begin{itemize}[nosep]
        \hypo{Python経験者の割合が高い（筆者: 2.22 vs Gemini: 85\%）}
        \hypo{学部間のスキル差が実質的に無視可能である点}
    \end{itemize}
}
...
現状を追認するだけの分析から脱却するため，以下の問いを設定する．
\begin{enumerate}
    \item \textbf{クラスター特性：} 「Excelは得意だがPGは1」という層と「PGは得意だがExcelは1」という層の学習障壁は，教育設計においてどう区別されるべきか？
